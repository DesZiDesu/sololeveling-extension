...
'use strict';
const R=globalThis.__SLX_SYSTEM_EXPANSION__;
const {C,n,A,core,ex,saveE,saveC,hist,balance,coreHistory,daily,tick,achievements,unlock,unlockUI,extract,patch,prompt,schedule,ui,norm,snapshot,restore,render,primeRewardLedger,settleAutomaticRewards,EK,V}=R;
